...
with att_sk:
    ...
    xg_gl.update_layout(annotations=[dict(text="Underperform", x=x_min+5, y=y_max, font_size=10, showarrow=False, xanchor='center'),
                                     dict(text="Overperform",x=x_max-2, y=y_min+2, font_size=10,showarrow=False,xanchor='center')])
