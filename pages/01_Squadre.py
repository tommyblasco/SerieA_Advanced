...
with gen_cor:
    ...
    gl1.write("""GolF: Gol Fatti, GolS: Gol Subiti, xG_for: Expected gol a favore, xGA: Expected gol concessi, 
                xA: Assist previsti""")
    gl2.write("""Tiri in porta, TiP_conc: Tiri in porta concessi, Possesso: Possesso palla, PF: Passaggi chiave, 
