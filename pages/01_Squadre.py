...
with gen_cor:
    ...
    st.write('Glossario:')
    st.write("""GolF: Gol Fatti, GolS: Gol Subiti, xG_for: Expected gol a favore, xGA: Expected gol concessi, xA: Assist previsti, 
             TiP: Tiri in porta, TiP_conc: Tiri in porta concessi, Possesso: Possesso palla, PF: Passaggi chiave, 
             PrgP: Passaggi progressivi, PPA: Passaggi in area """)
    y=df['Punti']
    ...
    cor_gr.update_yaxes(dict(title='Correlazione con Punti'))
